...
export interface ApiContactFormContactForm extends Schema.CollectionType {
  ...
  attributes: {
    ...
    sendCommunication: Attribute.Boolean;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiFooterFooter extends Schema.CollectionType {
  ...
  attributes: {
    ...
    enableTransparentBackground: Attribute.Boolean & Attribute.DefaultTo<false>;
    ...
    newsletterTitleColor: Attribute.String &
      Attribute.CustomField<'plugin::color-picker.color'>;
    fieldPlaceholder: Attribute.String;
    textPopup: Attribute.String;
    textColorPopup: Attribute.String &
      Attribute.CustomField<'plugin::color-picker.color'>;
    startColumn: Attribute.Component<'c4d-items.footer-column-items', true>;
    centerColumn: Attribute.Component<'c4d-items.footer-column-items', true>;
    endColumn: Attribute.Component<'c4d-items.footer-column-items', true>;
    legalItems: Attribute.Component<'c4d-items.footer-column-items', true>;
    socialMedias: Attribute.Component<'c4d-items.footer-social-items', true>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiMenuMenu extends Schema.CollectionType {
  ...
  attributes: {
    backgroundColor: Attribute.String &
      Attribute.CustomField<'plugin::color-picker.color'>;
    enableTransparentBackground: Attribute.Boolean;
    separationBarColor: Attribute.String &
      Attribute.CustomField<'plugin::color-picker.color'>;
    title: Attribute.String;
    titleColor: Attribute.String &
      Attribute.CustomField<'plugin::color-picker.color'>;
    ...
    menuItems: Attribute.Component<'c4d-items.menu-items', true>;
...
export interface ApiPagePage extends Schema.CollectionType {
  ...
  attributes: {
    slug: Attribute.UID<'api::page.page', 'Nom'>;
    Nom: Attribute.String;
    pageBackgroundColor: Attribute.String &
      Attribute.CustomField<'plugin::color-picker.color'>;
    showMenu: Attribute.Boolean;
    showFooter: Attribute.Boolean;
    ellipses: Attribute.Component<'c4d-components.ellipse', true>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
